async function segundo() {
    ...
    numeros.push(chileno, indonesio, japones, otro);
    var nombres = ["En Chile", "En Indonesia", "En Japon", "En el resto del mundo"];
        ...
        data: {
            ...
            datasets: [
                { 
                    label: "Earthquakes", 
                    data: numeros, 
                    backgroundColor: ["#1c313a", "#D74317", "#CCFFE5", "#718792"] 
                }
            ],
        },
        options: {
